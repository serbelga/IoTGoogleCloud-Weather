...
class NavigationIconClickListener @JvmOverloads internal constructor(
        ...
        private val openIcon: Int? = null, private val closeIcon: Int? = null) : View.OnClickListener {
    ...
    override fun onClick(view: View) {
        ...
        val translateY = height - context.resources.getDimensionPixelSize(R.dimen.height)
    ...
    private fun updateIcon(view: View) {
        if (openIcon != null && closeIcon != null) {
            ...
            if (backdropShown) {
                view.setImageResource(closeIcon)
            } else {
                view.setImageResource(openIcon)
            }
        }
    }
}
